...
var _require = require('./error'),
    UnrecognizedModuleTypeError = _require.UnrecognizedModuleTypeError;

var getModuleResource = function getModuleResource(module) {
  var moduleType = module.constructor.name;
  ...
  switch (moduleType) {
    ...
    case 'MultiModule':
      ...
      var multiModuleRegExp = /^multi (.+)$/;
      var multiModuleMatch = multiModuleRegExp.exec(module._identifier);
    ...
    case 'RawModule':
      ...
      var rawModuleRegExp = /^(.+) \(ignored\)$/;
      var rawModuleMatch = rawModuleRegExp.exec(module.readableIdentifierStr);
